...
{
    public class SiteManager : CostApprover
    {
        public bool canApprove(ProcurementManagmentContext context,PurchaseRequisitionDTO purchReq)
        {
            ...
            //Site manager
            SiteBudget myBudget = context.SiteBudgets.Where(budget => budget.UserType == CostApprover.SITE_MANAGER && budget.SiteId == purchReq.SiteId).ToArray<SiteBudget>()[0];
