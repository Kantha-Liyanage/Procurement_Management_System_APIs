...
{
    public class SiteSupervisor : CostApprover
    {
        public bool canApprove(ProcurementManagmentContext context,PurchaseRequisitionDTO purchReq)
        {
            ...
            //Site supervisor
            SiteBudget myBudget = context.SiteBudgets.Where(budget => budget.UserType == CostApprover.SITE_SUPERVISOR && budget.SiteId == purchReq.SiteId).ToArray<SiteBudget>()[0];
